...
# Revision: $Id: PackageManagement.pl,v 1.12 2012/01/09 09:55:50 eulisse Exp $ 
#
...
my $cvsrootAnon = ':pserver:anonymous@cmscvs.cern.ch:2401/cvs_server/repositories/'.$projectroot;
my $outdir;
my $rv;
my $releaseid;
my $baserel="none";
...
#	    $rv = system($cvs,"-Q","-d",$cvsroot,$checkout,"-P","-r",$packagelist->{$pkg}, $pkg);      
   ...
   if ($opts{ANONCVS})
       ...
       print $cvspass "/1 $cvsrootAnon AA_:yZZ3e\n";
